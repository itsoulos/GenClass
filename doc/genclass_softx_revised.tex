...
as mutation rate or number of chromosomes in the genetic population.\textbf{
...
the GenClass software can not used for regression problems in the
...
the public available library of OpenMP. The proposed method proved
...
as physics, chemistry, medicine etc. The user need to provide only
